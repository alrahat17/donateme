...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body card-block">
      <form action="{{url('/blogs/'.$blog->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="text" id="product_name" name="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$blog->title}}">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="file" id="media" name="media" class="form-control-file{{ $errors->has('media') ? ' is-invalid' : '' }}">
            ...
            @endif
          <img style="height: 90px;width: 120px;" src="{{URL::to($blog->media)}}">
          </div>
        </div>
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          ...
          if(file_size>2097152){
           $('#error_media').html('<label class="text-danger"><h6><small>Media Size Exceeds</small></h6></label>');
           $('#media').addClass('has-error');
           $('#register').attr('disabled',false );
          }
          else{
