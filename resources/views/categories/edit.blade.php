                      ...
                      <div class="card-body card-block">
                        <form action="{{url('/categories/'.$category->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="product_name" name="cat_name" class="form-control{{ $errors->has('cat_name') ? ' is-invalid' : '' }}" value="{{$category->cat_name}}" >
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="cat_img" name="cat_img" class="form-control-file{{ $errors->has('cat_img') ? ' is-invalid' : '' }}">
