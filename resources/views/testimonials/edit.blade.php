...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body card-block">
      <form action="{{url('/testimonials/'.$testimonial->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="text" id="name" name="name"  class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$testimonial->name}}">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><textarea name="test_des" id="test_des" rows="3" class="form-control{{ $errors->has('test_des') ? ' is-invalid' : '' }}">{{$testimonial->test_des}}</textarea>
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="file" id="test_img" name="test_img" class="form-control-file{{ $errors->has('test_img') ? ' is-invalid' : '' }}">
            ...
            <img style="height: 90px;width: 120px;" src="{{URL::to($testimonial->test_img)}}">
          </div>
