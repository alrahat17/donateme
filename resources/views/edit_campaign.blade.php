  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9 well admin-content">
        <form action="{{url('/update_campaign',$campaign->id)}}" class="form-horizontal" method="post" class="probootstrap-form" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group">
            <label class="col-md-4 control-label" for="cam_name">Campaign Title</label>
            <div class="col-md-6">
              <input type="text" class="form-control{{ $errors->has('cam_name') ? ' is-invalid' : '' }}" id="cam_name" name="cam_name" value="{{$campaign->cam_name}}" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="number" class="form-control{{ $errors->has('goal') ? ' is-invalid' : '' }}" id="goal" name="goal" value="{{$campaign->goal}}">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="date" class="form-control{{ $errors->has('cam_date') ? ' is-invalid' : '' }}" id="cam_date" name="cam_date" value="{{$campaign->cam_date}}">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control{{ $errors->has('cam_loc') ? ' is-invalid' : '' }}" id="cam_loc" name="cam_loc" value="{{$campaign->cam_loc}}" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="url" class="form-control{{ $errors->has('video') ? ' is-invalid' : '' }}" id="cam_loc" name="video" value="{{$campaign->video}}">
            @if($campaign->video)
            <br>
            <iframe width="240" height="170" src="https://www.youtube.com/embed/{{$video_id[3]}}"></iframe>
            @endif        
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">              
           <textarea class="form-control" id="mytextarea" name="cam_des" rows="12">{{$campaign->cam_des}}</textarea>
