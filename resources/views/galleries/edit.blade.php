    ...
    <div class="card-body card-block">
      <form action="/galleries" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="text" id="title" name="title"  class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$gallery->title}}">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="text" id="sub_title" name="sub_title"  class="form-control{{ $errors->has('sub_title') ? ' is-invalid' : '' }}" value="{{$gallery->sub_title}}">
        ...
        <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="file" id="gal_img" name="gal_img" class="form-control-file{{ $errors->has('gal_img') ? ' is-invalid' : '' }}">
            ...
            @endif
            <br>
            <img style="height: 90px;width: 120px;" src="{{URL::to($gallery->gal_img)}}">
          </div>
