...
<div class="col-lg-12">
	<div class="card">
		...
		<div class="card-body card-block">
			<form action="{{url('/update_user',$user->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="userForm">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="text" id="name" name="name"  class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$user->name}}">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="text" id="user_name" name="user_name"  class="form-control{{ $errors->has('user_name') ? ' is-invalid' : '' }}" value="{{$user->user_name}}">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="email" id="email" name="email"  class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{$user->email}}">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="number" id="phone" name="phone"  class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{$user->phone}}">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9">
						<select name="user_type" id="user_type" class="form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}">
							...
							<option {{ $user->user_type == 'customer' ? 'selected':'' }} value="customer">Customer</option>	
						</select>
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="password" id="password" name="password"  class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"><span id="error_password"></span>
      ...
      <script>
        ...
        $(document).ready(function(){
          ...
          if(user_name.length<3){
           $('#error_user_name').html('<label class="text-danger"><h6><small><i>User Name must be atleast 3 charcters long</i></small></h6></label>');
